...
ns.L = {
    ...
    EnableShroudCountdownDesc = "은폐의 장막 카운트다운 메시지를 채팅에 보냅니다.",
    ShroudOnlyInstancesDesc = "은폐의 장막 메시지를 인스턴스에서만 보냅니다.\n\n참고: 일부 채널은 인스턴스 밖에서 블리자드 스팸 방지로 차단됩니다.",
    ShroudMuteErrors = "오류 메시지 끄기",
    ShroudMuteErrorsDesc = "은폐의 장막 관련 오류 메시지를 채팅에 출력하지 않습니다.",
    ChatChannelDesc = "은폐의 장막 메시지의 기본 채팅 채널입니다.",
    ChatChannelFallbackDesc = "이전 채널이 불가할 때 사용할 대체 채널입니다.",
    ShroudMessageDesc = "카운트다운 중 사용할 메시지 템플릿입니다.\n\n%time = 남은 시간.",
    ShroudOnStartDesc = "은폐의 장막 시작 시 보낼 메시지입니다.",
    ShroudOnEndDesc = "은폐의 장막 종료 시 보낼 메시지입니다(0초).",
    TestShroudDesc = "5초 로컬 카운트다운을 시뮬레이션합니다.\n\n참고: 메시지는 나에게만 표시됩니다.",
    ...
    ErrorShroudOnlyInstances = "Night|cffA361E2veil|r: |cffff2020은폐의 장막 메시지는 인스턴스 안에서만 작동합니다.|r",
    ...
    -- Debug Mode
    DebugModeActivated = "Night|cffA361E2veil|r: |cff00ff00디버그 모드 활성화됨|r",
    DebugModeDeactivated = "Night|cffA361E2veil|r: |cffff2020디버그 모드 비활성화됨|r",
    DebugModeRequired = "Night|cffA361E2veil|r: |cffff2020이 명령어는 디버그 모드가 필요합니다.|r 활성화하려면 |cffffd100/veil debug|r 를 입력하세요.",
    DebugCommandList1 = " |cffffd100/veil info|r - 기술 진단 정보를 출력합니다",
    DebugCommandList2 = " |cffffd100/veil shroud [1-20]|r - 은폐의 장막 카운트다운을 시뮬레이션합니다 (기본값: 15초)",
    -- Debug Info
    DebugHeader = "Night|cffA361E2veil|r 진단:",
    DebugCombat = " - 전투: %s",
    DebugStealth = " - 은신: %s",
    DebugInstance = " - 인스턴스: %s (유형: %s)",
    DebugGroup = " - 그룹: %s (공격대: %s, 총: %d)",
    DebugComposition = " - 구성: |cff00ff00%d 플레이어|r, |cff00d1ff%d 소환수|r, |cffff0000%d 기타|r",
    ...
    DebugNone = "없음",
    DebugUnknown = "알 수 없음",
    DebugFallback1 = " - 대체 1: |cffffff00%s|r (사용 가능: %s)",
    DebugFallback2 = " - 대체 2: |cffffff00%s|r (사용 가능: %s)",
    DebugShroudUsage = "Night|cffA361E2veil|r: |cffff2020사용법:|r |cffffd100/veil shroud [1-20]|r",
}
