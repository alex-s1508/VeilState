...
ns.L = {
    ...
    EnableShroudCountdownDesc = "Sendet Countdowns für Verhüllender Nebel im Chat.",
    ShroudOnlyInstancesDesc = "Sendet Nachrichten für Verhüllender Nebel nur in Instanzen.\n\nHinweis: Einige Kanäle sind außerhalb von Instanzen durch Blizzard-Antispam blockiert.",
    ShroudMuteErrors = "Fehlermeldungen stummschalten",
    ShroudMuteErrorsDesc = "Deaktiviert Fehlermeldungen für Verhüllender Nebel im Chat.",
    ChatChannelDesc = "Primärer Chatkanal für Nachrichten für Verhüllender Nebel.",
    ...
    ShroudOnStartDesc = "Nachricht beim Start von Verhüllender Nebel.",
    ShroudOnEndDesc = "Nachricht beim Ende von Verhüllender Nebel (0s).",
    TestShroudDesc = "Simuliert einen lokalen 5-Sekunden-Countdown.\n\nHinweis: Die Nachrichten sind nur für dich sichtbar.",
    ...
    ErrorShroudOnlyInstances = "Night|cffA361E2veil|r: |cffff2020Meldungen für Verhüllender Nebel funktionieren nur in Instanzen.|r",
    ...
    -- Debug Mode
    DebugModeActivated = "Night|cffA361E2veil|r: |cff00ff00Debug-Modus AKTIVIERT|r",
    DebugModeDeactivated = "Night|cffA361E2veil|r: |cffff2020Debug-Modus DEAKTIVIERT|r",
    DebugModeRequired = "Night|cffA361E2veil|r: |cffff2020Dieser Befehl erfordert den Debug-Modus.|r Gib |cffffd100/veil debug|r ein, um ihn zu aktivieren.",
    DebugCommandList1 = " |cffffd100/veil info|r - Zeigt technische Diagnosen an",
    DebugCommandList2 = " |cffffd100/veil shroud [1-20]|r - Simuliert Verhüllender Nebel Countdown (Standard: 15s)",
    -- Debug Info
    DebugHeader = "Night|cffA361E2veil|r Diagnose:",
    DebugCombat = " - Kampf: %s",
    DebugStealth = " - Verstohlenheit: %s",
    DebugInstance = " - Instanz: %s (Typ: %s)",
    DebugGroup = " - Gruppe: %s (Schlachtzug: %s, Gesamt: %d)",
    DebugComposition = " - Zusammensetzung: |cff00ff00%d Spieler|r, |cff00d1ff%d Begleiter|r, |cffff0000%d Andere|r",
    ...
    DebugFallback1 = " - Ausweich 1: |cffffff00%s|r (Nutzbar: %s)",
    DebugFallback2 = " - Ausweich 2: |cffffff00%s|r (Nutzbar: %s)",
    DebugShroudUsage = "Night|cffA361E2veil|r: |cffff2020Verwendung:|r |cffffd100/veil shroud [1-20]|r",
}
