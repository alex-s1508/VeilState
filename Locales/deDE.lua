...
ns.L = {
    ...
    TricksFocusDesc = "Ermöglicht automatisierte Zielerfassung über das Fokusziel.\n\nHinweis: Dies hat Priorität vor dem Zielselektor, wird jedoch durch Mouseover oder Delve Companion ignoriert.",
    ...
    TricksBtnEnable = "Aktivieren & Makro synchronisieren",
    TricksBtnDisable = "Deaktivieren & Makro entfernen",
    TricksBtnDisableDesc = "Deaktiviert die automatisierte Zielerfassung und entfernt das Makro vollständig.",
    ...
    TricksAlreadyEnabled = "Schurkenhandel ist bereits aktiviert.",
    TricksAlreadyDisabled = "Schurkenhandel ist bereits deaktiviert.",
    ...
    DebugCombatLock = "Diese Aktion kann nicht im Kampf verwendet werden.",
}
