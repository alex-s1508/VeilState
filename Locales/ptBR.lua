...
ns.L = {
    ...
    TricksNormal = "Normal",
    TricksMacroWarning = "Use o macro \"|cffffa500Nightveil - Tricks|r\" ao invés da habilidade original.",
    TricksEnabledDesc = "Ativa o direcionamento automático para Truques do Ofício usando um macro.",
    ...
    DebugCombatLock = "Este comando não pode ser usado em combate.",
}
